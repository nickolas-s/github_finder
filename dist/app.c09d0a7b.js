...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/fetch.js":[function(require,module,exports) {
"use strict";
...
async function getUser(user) {
  // Fetch User
  const profileReponse = await fetch(`https://api.github.com/users/${user}?client_id=${clientId}&client_secret=${clientSecret}`);
  const profile = await profileReponse.json(); // Fetch Repos

  const repoReponse = await fetch(`https://api.github.com/users/${user}/repos?per_page=${reposCount}&sort=${repostSort}&client_id=${clientId}&client_secret=${clientSecret}`);
  const repos = await repoReponse.json(); // Return both as an Object
...
function showProfile(user) {
  _elements.profileDisplay.innerHTML = `
  <div class="card card-body mb-3">
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <br><br>
          <ul class="list-group">
            <li class="list-group-item">Company: ${user.company !== null ? user.company : '---'}</li>
            <li class="list-group-item">Website/Blog: ${user.blog !== '' ? `<a href="${!user.blog.search(/http/) ? user.blog : `http://${user.blog}`}" target="_blank">${user.blog}</a>` : '---'}</li>
            <li class="list-group-item">Location: ${user.location !== null ? user.location : '---'}</li>
            <li class="list-group-item">Member Since: ${(0, _dateFns.format)(new Date(user.created_at), 'MMMM yyyy')}</li>
          </ul>
        </div>
      </div>
    </div>
...
async function showAlert(message, className1, className2) {
  ...
  if (!currentAlert) {
    ...
    _elements.profileDisplay.insertAdjacentElement('beforebegin', div);
...
},{"waait":"node_modules/waait/index.js","date-fns":"node_modules/date-fns/esm/index.js","./elements.js":"scripts/elements.js"}],"scripts/handlers.js":[function(require,module,exports) {
"use strict";
...
async function handleClick(e) {
  ...
  if (userText) {
    const user = await (0, _fetch.default)(userText);

    if (user.profile.message === 'Not Found') {
      (0, _ui.showAlert)('User not found', 'alert', 'alert-danger');
    } else {
      (0, _ui.showProfile)(user.profile);
      (0, _ui.showRepos)(user.repos);
    }
  } else {
    (0, _ui.clearProfile)();
  }
...
exports.default = _default;
},{"./fetch.js":"scripts/fetch.js","./ui.js":"scripts/ui.js"}],"scripts/app.js":[function(require,module,exports) {
"use strict";

var _handlers = _interopRequireDefault(require("./handlers.js"));

var _elements = require("./elements.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_elements.searchUser.addEventListener('keyup', _handlers.default);
},{"./handlers.js":"scripts/handlers.js","./elements.js":"scripts/elements.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
